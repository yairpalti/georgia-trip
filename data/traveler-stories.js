...
const TRAVELER_STORIES = {
  ...
  8: {
    pageIntro:
      "הלב של סוואנטי – טרק מסטיה–זהאבשי–אדישי–אושגולי, guesthouses, טיפים ומחירי מוניות. כולל לקחים פרקטיים מסיפור דרך מלא. מקורות: אוגוסט 2026, georgia.org.il.",
    stories: [
      {
        title: "לקחים פרקטיים לטרק מסטיה–אושגולי",
        author: "סיכום מסיפור דרך",
        date: "אוגוסט 2026",
        image: "IMG.ushguli",
        paragraphs: [
          "סיפור דרך מעולה ומלא – ריכוז התובנות, הטעויות והטיפים המרכזיים שעלו ממנו. רלוונטי במיוחד לימים 7–8 בתוכנית שלנו (עלייה למסטיה + טרק/אושגולי).",
        ],
        sections: [
          {
            title: "תחבורה ולוגיסטיקה",
            items: [
              "רכבת טביליסי–זוגדידי: כדאי להזמין כרטיסים זמן רב מראש (הם אוזלים מהר) ולהשקיע במחלקה בינונית/ראשונה עבור מיזוג ומרווח.",
              "מרשוטקה מזוגדידי למסטיה: לצאת מיד מהרכבת לתפיסת המרשוטקה הראשונה, כיוון שהנהגים ממתינים למילוי מלא של הרכב (יכול לקחת מעל שעה וחצי עיכוב). לסובלים מבחילות מומלץ לשבת מקדימה.",
              "אפליקציית Maxim: תחליף זול ונוח ממוניות מקומיות ומרשוטקות עבור נסיעות בין-עירוניות ארוכות (כמו מסטיה לקוטאיסי).",
              "מקלות הליכה בטיסה: נתון לשיקול הביטחון בשדה. מומלץ להצניע בתוך התיק או לשלוח לבטן המטוס כדי למנוע החרמה.",
            ],
          },
          {
            title: "התנהלות בטרק ובכפרים",
            items: [
              "משקל עודף: חובה להשאיר את המוצ'ילה/המזוודה הראשית בהוסטל במסטיה ולצאת לטרק רק עם תיק יום קל.",
              "חציית הנהר באדישי: מומלץ לקחת סוס (כ-25 לארי) עקב מים קפואים וזרם חזק.",
              "אוכל לצהריים: מקובל לארוז שאריות מארוחת הבוקר העשירה בגסטהאוס למהלך ההליכה.",
            ],
            subsections: [
              {
                title: "רמת הגסטהאוסים",
                items: [
                  "זבאשי (Zhabeshi): מומלץ במיוחד (כמו Guest House Victor) עם אירוח ושפע חריג.",
                  "אדישי (Adishi): כפר נידח יותר, תשתיות פשוטות יחסית וללא קליטה סלולרית סדירה (יש להנמיך ציפיות לינה).",
                  "איפררי (Iprali): לינה מומלצת ב-Betegi.",
                ],
              },
            ],
          },
          {
            title: "המלצות מסלול וזמנים",
            items: [
              "גשם בקיץ: באוגוסט נפוצים גשמים בשעות אחר הצהריים (סביב 16:00) – מומלץ לצאת מוקדם בבוקר ולהצטייד במעילי גשם וכיסוי תיק.",
              "מקטע אחרון (איפררי–אושגולי): נחשב לפחות מרשים נופית ביחס לימים הקודמים; מי שקצר בזמן או בעל עייפות מצטברת יכול לשקול דילוג עליו ברכב.",
            ],
          },
        ],
        links: [
          { label: "Maxim – אפליקציה", url: "https://www.google.com/maps/search/Maxim+taxi+Georgia" },
          { label: "Guest House Victor – Zhabeshi", url: "https://www.google.com/maps/search/Guest+House+Victor+Zhabeshi" },
          { label: "Betegi – Iprali", url: "https://www.google.com/maps/search/Betegi+Iprali+Georgia" },
          { label: N.mestia, url: "https://www.google.com/maps/search/Mestia+Georgia" },
