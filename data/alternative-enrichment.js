    ...
    0: {
      ...
      activities: [
        ...
        },
        {
          ...
          duration: "ערב",
          description:
            "check-in במלון (Booking 25.9–26.9, מ-14:00). דירוג 9.2 · מיקום 9.8 · WiFi · חניה · מסעדה. מחר יציאה לראצ'ה.",
          link: "https://www.booking.com/hotel/ge/hotel-in-chiatura.html",
          linkLabel: N.hotelChiatura,
          image: "IMG.chiatura",
        },
      ],
    },
    1: {
      driving: "כ-110 ק\"מ ל-Sveri + חזרה לצ'יאתורה · רכב עצמי",
      description:
        "אופציה ב' – Via Ferrata ב-Sveri Adventure Camp (Camp in Georgia). ברכב שלכם (~2 ש' מקוטאיסי). הזמנה ישירות מהמחנה (~€35) או מפגש עם Rafting in Kutaisi (₾200 – ללא הסעה). שחייה, BBQ. ערב: check-in במלון בצ'יאתורה (Booking 25.9–26.9).",
      image: "IMG.rafting",
      link: "https://campingeorgia.ge/hiking/",
      linkLabel: "Camp in Georgia – Via Ferrata",
      tips: [
        "Camp in Georgia ישירות: ~€35 · +995 558 48 63 48",
        "Rafting in Kutaisi: ₾200 · +995 595 41 15 47 · ללא הסעה",
      ...
      activities: [
        ...
        {
          name: N.campInGeorgia,
          timeOfDay: "10:00–10:30",
          duration: "30 דק'",
          description:
            "הגעה ל-Sveri Adventure Camp. הדרכה במחנה (30 דק'), ציוד, הליכה 15 דק' למסלול.",
          link: "https://campingeorgia.ge/camp/",
          linkLabel: "Camp in Georgia – המחנה",
          image: "IMG.rafting",
        },
        {
          name: N.sveriViaFerrata,
          timeOfDay: "10:30–14:00",
          duration: "2–2.5 ש'",
          description:
            "מסלול מונחה – 230 מ', 2 רמות (קל/בינוני), מעבר במערות קצרות. שני מדריכים.",
          link: "https://campingeorgia.ge/hiking/",
        ...
        },
        {
          ...
          duration: "~1 ש'",
          description:
            "Sveri → מלון בצ'יאתורה (רח' ილია ჭავჭავაძე). Booking 25.9–26.9 · check-in מ-14:00 · דירוג 9.2 (Wonderful) · מיקום 9.8 · WiFi · חניה · מסעדה.",
          link: "https://www.booking.com/hotel/ge/hotel-in-chiatura.html",
          linkLabel: N.hotelChiatura,
          image: "IMG.chiatura",
        },
