...
const ALTERNATIVE_ENRICHMENT = {
  3: {
    0: {
      ...
      activities: [
        ...
        },
        {
          ...
          duration: "45 דק'",
          description: "מנזר חצוב בסלע. המשך קצר ל-Prime Heaven.",
    ...
    1: {
      ...
      description:
        "אופציה ב' – Via Ferrata ב-Sveri Adventure Camp (Camp in Georgia). ברכב שלכם (~2 ש' מקוטאיסי). הזמנה ישירות מהמחנה (~€35) או מפגש עם Rafting in Kutaisi (₾200 – ללא הסעה). שחייה, BBQ. ערב: Prime Heaven, צ'יאתורה (Booking 25.9–26.9).",
      image: "IMG.rafting",
