...
const ROUTE_COORDS = [
  ...
  { name: N.whiteHotelGuesthouse, lat: WHITE_HOTEL.lat, lng: WHITE_HOTEL.lng, day: 6 },
...
const ROUTE_SEGMENTS = [
  ...
  },
  {
    ...
    to: { name: N.whiteHotelGuesthouse, lat: WHITE_HOTEL.lat, lng: WHITE_HOTEL.lng },
    waypoints: [
  ...
  {
    day: 7,
    from: { name: N.whiteHotelGuesthouse, lat: WHITE_HOTEL.lat, lng: WHITE_HOTEL.lng },
  ...
  },
  {
    day: 9,
    from: { name: N.mestiaAirbnb, lat: 43.0432, lng: 42.719788 },
    to: { name: N.mazeriCabin, lat: PEAK_MAZERI.lat, lng: PEAK_MAZERI.lng, overnight: true },
  ...
  {
    day: 10,
    from: { name: N.mazeriCabin, lat: PEAK_MAZERI.lat, lng: PEAK_MAZERI.lng },
    to: { name: N.mazeriCabin, lat: PEAK_MAZERI.lat, lng: PEAK_MAZERI.lng },
  ...
  },
  {
    ...
    to: { name: N.batumi, lat: 41.6168, lng: 41.6367 },
    waypoints: [
      { name: N.ureki, lat: 41.9969, lng: 41.7793 },
      { name: N.tsitsinatela, lat: 41.9068, lng: 41.7769 },
    ],
...
const DAYS = [
    ...
    alternatives: [
      ...
      },
      {
        ...
        tips: [
          ...
          "check-in מ-14:00 · הגעה ~14–15 · $154 · WiFi · חניה חינם · בלי ארוחות · ביטול עד 23.9 · +995 599 51 41 52",
    ...
    hotels: [
      {
        ...
        lat: PRIME_HEAVEN.lat,
        lng: PRIME_HEAVEN.lng,
        note: "✅ Booked · 25.9–26.9 · 3 rooms · $154 · check-in מ-14:00 (הגעה ~14–15) · WiFi · חניה חינם · בלי ארוחות · ביטול חינם עד 23.9 · +995 599 51 41 52",
      ...
      },
      {
        ...
        area: N.ambrolauri,
        nights: 1,
        address: "Village Ukeshi, Racha, Ambrolauri 0417, Georgia",
        note: "בוטל · Ambrolauri · אופציה באזור ראצ'ה (לא מוזמן)",
        link: "https://www.google.com/maps/search/?api=1&query=42.512732,43.144137",
        image: "IMG.racha",
      },
    ],
    mapPoints: [
  ...
  },
  {
    ...
    summary:
      "יוצאים מלינת יום 5 – אוקאצה (גשרים תלויים) → מרטווילי (מים טורקיז, שייט) → נוקאלאקווי. אופציה: טיול ג'יפים עם Bacho Tsotsoria. לינה: White Hotel Guesthouse בזוגדידי (Booked · 28.9–29.9).",
    activities: [
      {
        name: N.okatseCanyon,
        description:
    ...
    hotels: [
      {
        ...
        nights: 1,
        booked: true,
        address: WHITE_HOTEL.address,
        lat: WHITE_HOTEL.lat,
        lng: WHITE_HOTEL.lng,
        note: "✅ Booked · 28.9–29.9 · 2 rooms · ~$115 (GEL 300) · check-in 07:00–00:00 (הגעה ~16–17) · בלי ארוחות · מזומן בלבד · ביטול חינם עד 26.9 · +995 571 25 25 20 · conf. 5528.261.271",
        link: "https://www.google.com/maps/search/?api=1&query=42.508974,41.870705",
        bookingUrl: "https://www.booking.com/Share-qT3VBX",
        image: "IMG.martvili",
      },
    ],
    mapPoints: [
      ...
      { name: N.martvili, lat: 42.4167, lng: 42.3667 },
      { name: N.nokalakeviHotSprings, lat: 42.3533, lng: 42.3167 },
      { name: N.whiteHotelGuesthouse, lat: WHITE_HOTEL.lat, lng: WHITE_HOTEL.lng, overnight: true },
    ],
  },
  {
    id: 7,
    ...
    hotels: [
      {
        ...
        nights: 2,
        booked: true,
        address: "21 Mestia, Samegrelo-Zemo Svaneti 3200, Georgia",
        note: "✅ Booked · 29.9–1.10 · Home in Mestia Airbnb · 21 Mestia",
        link: "https://www.google.com/maps/search/?api=1&query=43.043200,42.719788",
        bookingUrl: "https://www.airbnb.com/trips/v1/1759464519441989123/ro/RESERVATION2_CHECKIN/HMN32SS2XJ",
        image: "IMG.mestia",
      },
    ],
    mapPoints: [
    ...
    hotels: [
      {
        ...
        booked: true,
        address: "21 Mestia, Samegrelo-Zemo Svaneti 3200, Georgia",
        note: "✅ Booked · Airbnb – לילה שני (30.9) · 21 Mestia",
        link: "https://www.google.com/maps/search/?api=1&query=43.043200,42.719788",
        bookingUrl: "https://www.airbnb.com/trips/v1/1759464519441989123/ro/RESERVATION2_CHECKIN/HMN32SS2XJ",
        image: "IMG.ushguli",
      },
  ...
  },
  {
    ...
    summary: "בוקר: check-out מ-Airbnb במסטיה (1.10) · טרק לקרחון צ'לאדי. אחר הצהריים: נסיעה למאזרי – Peak Mazeri Guest House (Booked).",
    activities: [
      {
      ...
      {
        name: N.mazeriCabin,
        description: `נסיעה של כ-45 דקות ל${N.mazeri.split(" · ")[0]}, ${N.bechoValley.split(" · ")[0]} – check-in ב-Peak Mazeri Guest House (Booked · 1.10–3.10, 3 rooms).`,
        link: "https://www.google.com/maps/search/Peak+Mazeri+Guest+House+Mazeri",
        linkLabel: N.mazeriCabin,
      },
    ],
    alternatives: [
      {
    ...
    hotels: [
      {
        ...
        nights: 2,
        booked: true,
        address: PEAK_MAZERI.address,
        lat: PEAK_MAZERI.lat,
        lng: PEAK_MAZERI.lng,
        note: "✅ Booked · 1.10–3.10 · Peak Mazeri Guest House · 3 rooms · ~$240 (GEL 625) · check-in 13:00–23:30 · ארוחת בוקר כלולה · מזומן בלבד · ביטול חינם עד 27.9 · +995 595 70 27 51 · conf. 5938.193.291",
        link: "https://www.google.com/maps/search/?api=1&query=43.07843,42.60767",
        image: "IMG.ushba",
      },
    ],
    mapPoints: [
      ...
      { name: N.mazeriCabin, lat: PEAK_MAZERI.lat, lng: PEAK_MAZERI.lng, overnight: true },
    ],
  },
  {
    id: 10,
    ...
    summary: "התעוררות בטבע. המסלול אל מפל שדוגרה יוצא ממש מהעמק – 4–5 שעות הליכה. אחרי הטרק: מקלחת חמה ולילה שני רגוע ב-Peak Mazeri Guest House.",
    activities: [
      {
      ...
      {
        name: N.bechoValley,
        description: "שארית היום והערב ברגוע ב-Peak Mazeri – נוף להרים ולפסגת אושבה.",
    ...
    hotels: [
      {
        ...
        lat: PEAK_MAZERI.lat,
        lng: PEAK_MAZERI.lng,
        note: "✅ Booked · לילה שני (2.10) · Peak Mazeri Guest House · 3 rooms · ~$240 · ארוחת בוקר כלולה · +995 595 70 27 51",
        link: "https://www.google.com/maps/search/?api=1&query=43.07843,42.60767",
        image: "IMG.ushba",
      },
    ],
...
שעות פעילות: 00:00–23:59 (כל יום, 7/7).`,
  ...
  accommodationSummary: [
    ...
    { place: N.primeHeaven, nights: 1, note: "✅ Booked · יום 3 · 25.9–26.9 · 3 rooms · $154 · Chiatura · ביטול עד 23.9" },
    ...
    { place: N.whiteHotelGuesthouse, nights: 1, note: "✅ Booked · יום 6 · 28.9–29.9 · 2 rooms · ~$115 · ביטול עד 26.9 · +995 571 25 25 20" },
    { place: N.mestiaAirbnb, nights: 2, note: "✅ Booked · ימים 7–8 · Airbnb 29.9–1.10 · 21 Mestia" },
    { place: N.mazeriCabin, nights: 2, note: "✅ Booked · ימים 9–10 · Peak Mazeri · 1.10–3.10 · 3 rooms · ~$240 · ארוחת בוקר · ביטול עד 27.9" },
