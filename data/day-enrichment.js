...
const DAY_ENRICHMENT = {
  ...
  7: {
    ...
    tips: [
      "🚗 SUV – הגעה מזוגדידi · 🚙 ג'יפ רק אם Koruldi בערב (אופציה)",
      ...
      "אופציה בערב: אגמי Koruldi – ג'יפ 4×4 (~45 דק' ממסטיה), לתאם מראש",
    ...
    alternativeExtras: {
      0: {
        ...
        duration: "2–2.5 שעות",
        tips: ["ג'יפ + נהג – לתאם ב-Airbnb / מרכז מסטיה", "לבוש חם – ~2,850 מ'"],
        image: "IMG.koruldi",
      },
    },
    extraRestaurants: [
  ...
  8: {
    ...
    tips: [
      "🚙 ג'יפ 4×4 חובה – הרכב השכור חונה במסטיה",
  ...
  11: {
    ...
    tips: [
      "Koruldi – ג'יפ 4×4 בלבד · לדלג אם ביקרתם בערב יום 7",
