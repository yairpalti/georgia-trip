...
const DAY_ENRICHMENT = {
  ...
  3: {
    ...
    tips: [
      ...
      "אופציה ב' – להזמין Via Ferrata מראש: raftinginkutaisi.com · +995 595 41 15 47",
  ...
  4: {
    ...
    tips: [
      "רפטינג – Rafting in Kutaisi (₾150) · raftinginkutaisi.com · +995 595 41 15 47",
      "אופציה ב' – יום כפול רפטינג + קניונינג Shareula (₾200) – לתאם מראש",
