...
const HIKING_TRAILS = {
  ...
  8: {
    intro: "מאושגולי – הליכה או סוסים לקרחון שחארה. המסלול יחסית שטוח לאורך העמק; היום עצמו כולל גם נסיעת 4×4.",
    trails: [
      {
        id: "shkhara",
        name: N.shkharaGlacier,
        length: "~8–10 ק\"מ הלוך-חזור מאושגולי",
        duration: "3–4 שעות הליכה (או ~2 ש' בסוסים + הליכה קצרה)",
        ...
        start: fmt("אושגולי – כפר / נקודת סוסים", "Ushguli – village / horse point", "უშგული"),
        description:
          "מאושגולי ממשיכים לאורך העמק לכיוון קרחון Shkhara. אפשר סוסים (~20–30 ₾) או הליכה. נוף לפסגות מושלגות. לחזור לאושגולי לפני ירידת הג'יפ למסטיה.",
        tips: [
          "לתאם שעת חזרה עם נהג הג'יפ",
