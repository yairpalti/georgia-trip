  ...
  items: [
    {
      ...
      date: "29.8.2026",
      badge: "הזמנות",
      title: "לינה מאושרת – צ'יאתורה, White Hotel, Airbnb מסטיה",
      summary:
        "שלוש הזמנות שעודכנו במסלול ובמפה: מלון בצ'יאתורה (25.9–26.9, Booking, דירוג 9.2) · White Hotel Guesthouse, Zugdidi (28.9–29.9, 2 חדרים, $115) · Home in Mestia Airbnb (29.9–1.10, 21 Mestia).",
      links: [
        { label: "יום 3 – מלון בצ'יאתורה", url: "day.html?id=3" },
        ...
        { label: "מלון בצ'יאתורה – Booking", url: "https://www.booking.com/hotel/ge/hotel-in-chiatura.html" },
